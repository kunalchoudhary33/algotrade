...
print("#################  Streaming started. Data will renderd once received from exchange.  #########################")
prev_ce_value = 0
prev_pe_value = 0
while True:

    oc_symbol = "NIFTY"
    oc_expiry = "01-02-2024"
    ...
    if oc_symbol is not None:
        try:
            ...
            if(prev_ce_value != sum_of_chng_oi_ce or prev_pe_value != sum_of_chng_oi_pe):
                ...
                pcr = formatINR(sum_of_chng_oi_pe - sum_of_chng_oi_ce)
